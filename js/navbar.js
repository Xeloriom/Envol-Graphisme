...
function createNavbar() {
    ...
    <div class="max-w-7xl mx-auto flex items-center justify-between">
      ...
      <div class="hidden md:flex items-center gap-8 font-bold">
        <a href="./" class="nav-link drop-shadow-xl bg-[#202940] hover:scale-105 hover:shadow-[0_0_10px_rgba(255,255,255,0.3)] text-[#DBE0F3] transition-colors px-6 py-3 backdrop-blur-sm rounded-full">BIENVENUE</a>
    ...
    <div id="mobile-menu" class="fixed inset-0 h-screen bg-[#1a1f35]/95 flex flex-col items-center justify-center gap-8 font-bold text-[#DBE0F3] text-2xl transform translate-y-[-100%] transition-transform duration-500 ease-in-out md:hidden">
      ...
      <a href="./" class="mobile-nav-link hover:text-white transition-all">BIENVENUE</a>
      <a href="View/Projets.html" class="mobile-nav-link hover:text-white transition-all">PROJETS</a>
      <a href="../View/offres" class="mobile-nav-link hover:text-white transition-all">OFFRES</a>
      <a href="../View/contact" class="mobile-nav-link hover:text-white transition-all">CONTACT</a>
    </div>
  `;
